...
<div x-data='{ ingrediants: {!! json_encode($ingrediants) !!},count:{{ count($ingrediants) }}  }'>
    <template x-for="i in count">
        <div class="flex flex-row items-center " x-data="{meassure:`measure ${i}`,ingredient:`ingredient ${i}`,meassure_text: ingrediants[i][0] ?? '',ingredient_text: ingrediants[i][1] ?? '' }">
