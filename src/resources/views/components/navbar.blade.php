<nav x-data="{ open: false }" class="bg-black border-b border-gray-100">
    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 bg-black">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex font-bold items-center text-white">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if ( !auth()->check() ||   Auth::user()->type =='normal'  )
                        ...
                        <x-nav-link :href="route('random-meal')">
                            Random recipe
                        </x-nav-link>
            ...
            @if ( auth()->check()   )
              ...
              @else
                <div class="sm:flex sm:gap-4">
                    <a
                        class="block rounded-md bg-yellow px-5 py-2.5 text-sm font-medium text-white transition hover:bg-yellow"
                        href="{{route('login')}}"
                    >
                        Login
                    </a>
                    ...
                    <a
                        class="hidden rounded-md bg-white px-5 py-2.5 text-sm font-medium text-yellow transition hover:text-yellow/75 sm:block"
                        href="{{route('register')}}"
                    >
                        Register
                    </a>
    ...
    <div class="block sm:hidden">
        <div :class="{'block': open, 'hidden': !open}" class="bg-black text-white">
            ...
            @if ( !auth()->check() ||   Auth::user()->type =='normal'  )
                ...
                <x-responsive-nav-link :href="route('random-meal')">
                    Random recipe
                </x-responsive-nav-link>
            @auth
